...
st.dataframe(data[['Close', 'liq_z', 'fng_signal', 'momentum_signal', 'final_score', 'signal']].tail(20))import streamlit as st
import pandas as pd
import numpy as np
import yfinance as yf
import requests
...
# ------------------------------
st.subheader("Recent Signals")
st.dataframe(data[['Close', 'liq_z', 'fng_signal', 'momentum_signal', 'final_score', 'signal']].tail(20))
